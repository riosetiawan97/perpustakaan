    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="<?= base_url().'admin' ?>"><img src="<?= base_url().'assets/images/icon/logo.png' ?>" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="" aria-expanded="true"><i class="ti-files"></i><span>Data</span></a>
                                <ul class="collapse">
                                    <li><a href="<?= site_url().'admin/tampil_buku' ?>"><i class="ti-book"></i><span>Buku</span></a></li>
